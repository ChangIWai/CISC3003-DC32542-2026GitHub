<?php
// Define the arrays for Genre and Subject
$genres = array("Abstract", "Baroque", "Gothic", "Renaissance");
$subjects = array("Animals", "Landscapes", "People");

// Function to generate <option> elements from an array
